 ...
 *     <brjs.Handler.Click> constructor.
 * 
 * Inherits from:
 *  - <brjs.Handler>
 */
brjs.Handler.Click = brjs.Object.create(brjs.Handler, {
    ...
    /**
     * Property: down
     * {<brjs.Pixel>} The pixel location of the last mousedown.
     */
    down: null,
    ...
    /**
     * Constructor: brjs.Handler.Click
        ...
        if(this.passesTolerance(evt)) {
           if(this.rightclickTimerId != null) {
                ...
                var clickEvent = this['double'] ?
                    brjs.Object.extend({}, evt) :
                    this.callback('rightclick', [evt]);

                var delayedRightCall = brjs.Function.bind(
        ...
        if(this.passesTolerance(evt)) {
            if(this.timerId != null) {
                ...
                var clickEvent = this.single ?
                    brjs.Object.extend({}, evt) : null;
                this.timerId = window.setTimeout(
                    brjs.Function.bind(this.delayedCall, this, clickEvent),
                    this.delay
                );
            }
        }
